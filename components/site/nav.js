...
const SKY_IMG =
  '/images/optimized/healthcare_interop.webp';
const DC_IMG =
  '/images/optimized/bfsi_banking.webp';
const ARCH_IMG =
  '/images/optimized/energy_grid.webp';
  ...
  },
  {
    ...
    panel: {
      lead: {
        ...
        description:
          'Senior-led engineering, product design, and digital growth practices — from web platforms to autonomous AI agents.',
      },
      categories: [
        { label: 'Website Development', href: '/what-we-do/cloud-modernization', icon: 'Globe' },
        { label: 'Mobile App Dev', href: '/what-we-do/ai-applied-intelligence', icon: 'Smartphone' },
        { label: 'AI Agent Development', href: '/what-we-do/enterprise-architecture', icon: 'Bot' },
        { label: 'View All Services', href: '/what-we-do', icon: 'Layers' },
      ],
      pages: [
        { title: 'Website Development', desc: 'High-performance web applications, Next.js, and custom design systems.', href: '/what-we-do/cloud-modernization', icon: 'Globe' },
        { title: 'Mobile App Development', desc: 'Native & cross-platform mobile apps for iOS and Android.', href: '/what-we-do/ai-applied-intelligence', icon: 'Smartphone' },
        { title: 'Software Development', desc: 'Custom enterprise software, microservices, and API ecosystems.', href: '/what-we-do/cybersecurity-zero-trust', icon: 'Code2' },
        { title: 'ERP Solutions', desc: 'Supply chain, inventory, finance, and operational ERP automation.', href: '/what-we-do/digital-transformation', icon: 'Building2' },
        { title: 'Digital Marketing', desc: 'Data-driven performance marketing, SEO, and brand positioning.', href: '/what-we-do/data-analytics-fabric', icon: 'TrendingUp' },
        { title: 'AI Agent Development', desc: 'Autonomous multi-agent systems, RAG fabrics, and custom LLMs.', href: '/what-we-do/enterprise-architecture', icon: 'Bot' },
      ],
      featured: {
        tag: 'Case Study',
        title: 'Enterprise AI Agent & Web Platform for Global FinTech.',
        cta: 'View case study',
        href: '/our-work',
        image: SKY_IMG,
      },
  ...
  },
  {
    ...
    panel: {
      lead: {
        ...
        description:
          'Peer-reviewed analysis, technical benchmarks, and regulatory briefs written exclusively by senior practice leads.',
      },
      categories: [
        { label: 'All Publications', href: '/blogs', icon: 'Layers' },
        { label: 'AI & Machine Learning', href: '/blogs?category=AI', icon: 'Cpu' },
        { label: 'Cloud & Infrastructure', href: '/blogs?category=Cloud', icon: 'Cloud' },
        { label: 'Security & Compliance', href: '/blogs?category=Security', icon: 'ShieldCheck' },
      ],
      pages: [
        { title: 'Sovereign LLM Architecture 2026', desc: 'Isolated RAG fabrics for European financial institutions.', href: '/blogs/sovereign-llm-architecture-2026', icon: 'Cpu' },
        { title: 'NIS2 & DORA Compliance Guide', desc: 'Audited SecOps playbooks for critical infrastructure.', href: '/blogs/nis2-dora-compliance-guide', icon: 'ShieldCheck' },
        { title: 'Multi-Cloud FinOps Optimization', desc: 'Eliminating cloud waste across AWS, Azure, and GCP.', href: '/blogs/multi-cloud-finops-optimization', icon: 'Cloud' },
        { title: 'Zero-Trust Identity Perimeters', desc: 'Passwordless PKI credentialing for Tier-1 banks.', href: '/blogs/zero-trust-identity-perimeters', icon: 'ShieldCheck' },
      ],
      featured: {
        tag: 'Featured Paper',
        title: 'Architecting Sovereign RAG Pipelines in Regulated Financial Verticals.',
        cta: 'Read full report',
        href: '/blogs/sovereign-llm-architecture-2026',
        image: SKY_IMG,
      },
    },
  },
