...
export default function HomePage() {
  ...
  return (
    <PageShell>
      ...
      <section
        className="relative text-white py-16 lg:py-20 font-sans overflow-hidden"
        style={{
          backgroundImage: "url('/images/metallic_bg.png')",
          backgroundSize: 'cover',
          backgroundPosition: 'center',
      ...
      <section className="bg-[#faf7f2] text-[#1c1a18] py-24 border-b border-[#e5dccf] font-sans">
        <div className="mx-auto max-w-[1500px] px-6 lg:px-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-14 border-l-4 border-[#86bc25] pl-5">
            <div>
            ...
            <p className="mt-3 md:mt-0 text-[14.5px] text-[#6b6255] max-w-md font-light leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {industriesData.map((item, i) => (
              <Link
                key={i}
                href={item.href}
                className="hover-mimag-border group flex flex-col justify-between bg-white border border-[#e4d7c5] rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300"
              >
                <div>
                  <div className="relative h-[210px] w-full overflow-hidden bg-[#1c1a18]">
                    ...
                    <span className="absolute top-4 left-4 bg-[#faf7f2] text-black px-3 py-1 rounded text-[10px] font-bold uppercase tracking-wider shadow">
                      {item.label}
                    </span>
                  </div>
                  ...
                  <div className="p-7">
                    ...
                    <p className="text-[14.5px] text-[#595248] font-normal leading-relaxed mb-6">
                      {item.description}
                    </p>
                  </div>
                </div>
                ...
                <div className="px-7 pb-6 pt-4 border-t border-[#f2ece2] flex items-center justify-between">
                  <span className="text-[12px] font-bold text-[#784813] uppercase tracking-wider">
                    {item.stats}
                  </span>
                  <span className="inline-flex items-center gap-1 text-[13px] font-bold text-[#1c1a18] group-hover:text-[#5e8817] transition-colors">
                    Explore Industry <ArrowRight className="h-3.5 w-3.5 group-hover:translate-x-1 transition-transform" />
                  </span>
                </div>
              </Link>
            ))}
      ...
      <section className="relative bg-gradient-to-b from-[#080d1a] via-[#0a162b] to-[#080d1a] text-white py-14 border-b border-[#1c3969] font-sans overflow-hidden">
        ...
        <div className="mx-auto max-w-[1500px] px-6 lg:px-12 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 pb-4 border-b border-[#1e3b6e]">
            <div>
            ...
            <p className="mt-2 md:mt-0 text-[14px] text-[#a9c4e6] max-w-md font-light leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {whyChooseUsData.map((item, idx) => (
              <div
                key={idx}
                className="hover-mimag-border group flex flex-col justify-between bg-[#0b1830]/90 border border-[#1d3969] rounded-xl p-6 shadow-lg hover:border-transparent hover:bg-[#102447] transition-all duration-300"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#142c54] text-[#86bc25] group-hover:bg-[#86bc25] group-hover:text-black transition-colors">
                  ...
                  <h3 className="text-[18px] font-bold text-white tracking-tight group-hover:text-[#86bc25] transition-colors mb-2">
                    {item.title}
                  </h3>
                  <p className="text-[13.5px] text-[#b0cae8] font-light leading-relaxed mb-4">
                    {item.desc}
                  </p>
                </div>

                <div className="pt-3 border-t border-[#1b3663] flex items-center justify-between text-[12.5px] text-[#84a9d4]">
        ...
        <div className="mx-auto max-w-[1500px] px-6 lg:px-12">
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6 border-l-4 border-[#86bc25] pl-6 py-1">
              <div>
                ...
                <p className="text-[14.5px] text-[#5c5449] font-light leading-relaxed mb-4">
                  Mimang Technologies is an independent enterprise technology consultancy providing software development, cloud modernization, applied AI solutions, and executive digital transformation. We replace bloated legacy consultancy pyramids with small, senior practitioner pods that deliver audited outcomes.
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-6 pt-1 text-[13.5px] text-[#554e44]">
                ...
                >
                  <Mail className="h-4 w-4 text-[#1c1a18]" /> partners@mimag.tech
                </a>
            ...
            <div className="lg:col-span-6">
              <form
                onSubmit={onSubmit}
                className="hover-mimag-border bg-white border border-[#e2d8c9] rounded-xl p-6 md:p-7 shadow-[0_8px_25px_rgba(0,0,0,0.03)] hover:border-transparent transition-all duration-300"
              >
